    ...
    <div class="top-header">
      <div class="container">
        ...
        <div class="search-input-container">
          ...
          <input type="text" id="header-product-autocomplete-input" 
          placeholder="Type your suburb here" onkeyup="headerProductKeyup(this)">
      ...
      <div class="row align-items-center">
          ...
          <div class="steps">
            ...
            <div class="step two">
              <div class="title">
                ...
                Step 2: <strong>Select the skip that suits you needs</strong>
              </div>
              <div class="icon">
                <i class="fa fa-check-circle"></i>
              </div>
        ...
        <div class="col-lg-4 offset-lg-1">
          <div class="price-info">
            All prices below reflect the price you will pay to hire a skip bin form West Coast Waste for 7 days, delivered to your door.
          </div>
        </div>
          ...
          <div class="col-lg-3">
            ...
            <?php endif; ?> 
              ...
              <div class="meta-info">
                <div class="info">
                  <div>
                    <img src="<?php echo get_template_directory_uri(); ?>/img/home-trailer.png" alt="Product Trailer" width="100%">
                  </div>
                ...
                <div class="info">
                  <div>
                    <img src="<?php echo get_template_directory_uri(); ?>/img/home-bin.png" alt="Product Bin" width="66%">
                  </div>
