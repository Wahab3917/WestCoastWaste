...
<form name="checkout" method="post" class="checkout woocommerce-checkout" action="<?php echo esc_url( wc_get_checkout_url() ); ?>" enctype="multipart/form-data">
	...
	<?php if ( $checkout->get_checkout_fields() ) : ?>
        ...
        <div class="woocommerce-checkout-acceptable-waste">
          ...
          <p>Owing to enviromental obligations, we can only accept certain waste products in our skip bin.
            the following is what can and cannot be accepted. Please
            call 1800 927 831 for further assistance or enquiries.</p>
          <ul>
            <li><i class="fa fa-check-circle"></i>Sand</li>
            <li><i class="fa fa-check-circle"></i>Timber</li>
            <li><i class="fa fa-check-circle"></i>Rubber</li>
            <li><i class="fa fa-check-circle"></i>Plastic</li>
          ...
          <ul>
            ...
            <li><i class="fa fa-check-circle"></i>Furnitrre</li>
            <li><i class="fa fa-check-circle"></i>Bricks</li>
          </ul>

          <ul class="not-allowed">
            <li><i class="fa fa-times-circle"></i>Batteries</li>
            <li><i class="fa fa-times-circle"></i>Tyres</li>
